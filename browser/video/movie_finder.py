...
from browser.video.closest_title_finder import ClosestTitleFinder, PossibleMatch
...
class MovieFinder:
    ...
    def in_page_movie_with_title(self, locator_movie_links: Locator, title_to_search: str) -> None:
